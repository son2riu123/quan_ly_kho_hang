...
-- ---------------------------------------------------------------------
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'QL_KHO1')
BEGIN
    CREATE DATABASE QL_KHO1;
END
GO
...
-- =====================================================================
-- 8. CẢNH BÁO TỒN KHO (7 bảng mới)
-- (Bảng NhatKyThaoTac ở mục 16.8 của đặc tả trùng với bảng NhatKyThaoTac
--  đã tạo ở Mục 7 nên KHÔNG tạo lại để tránh trùng lặp)
-- =====================================================================

-- 16.1 CanhBaoTonKho
CREATE TABLE CanhBaoTonKho (
    MA_CANH_BAO            CHAR(10)      NOT NULL,
    MA_KHO                 CHAR(10)      NOT NULL,
    MA_MAT_HANG            CHAR(10)      NOT NULL,
    MA_LO_HANG             CHAR(10)      NULL,
    MA_VI_TRI              CHAR(10)      NULL,
    LOAI_CANH_BAO          NVARCHAR(50)  NOT NULL,
    MUC_DO_UU_TIEN         NVARCHAR(30)  NOT NULL,
    SO_LUONG_HIEN_TAI      INT           NULL,
    NGUONG_CANH_BAO        INT           NULL,
    THOI_DIEM_PHAT_SINH    DATETIME2(0)  NOT NULL,
    TRANG_THAI_CANH_BAO    NVARCHAR(50)  NOT NULL,
    MO_TA                  NVARCHAR(255) NULL,
    GHI_CHU                NVARCHAR(255) NULL,
    CONSTRAINT PK_CanhBaoTonKho PRIMARY KEY (MA_CANH_BAO)
);
GO

-- 16.3 CauHinhDinhMucTon
CREATE TABLE CauHinhDinhMucTon (
    MA_CAU_HINH           CHAR(10)      NOT NULL,
    MA_KHO                CHAR(10)      NOT NULL,
    MA_MAT_HANG           CHAR(10)      NOT NULL,
    MUC_TON_TOI_THIEU     INT           NULL,
    MUC_TON_TOI_DA        INT           NULL,
    NGUONG_CAN_HAN        INT           NULL,
    TRANG_THAI            NVARCHAR(30)  NOT NULL,
    CONSTRAINT PK_CauHinhDinhMucTon PRIMARY KEY (MA_CAU_HINH)
);
GO

-- 16.2 ChiTietCanhBaoTonKho
CREATE TABLE ChiTietCanhBaoTonKho (
    MA_CHI_TIET_CANH_BAO   CHAR(10)      NOT NULL,
    MA_CANH_BAO            CHAR(10)      NOT NULL,
    MA_TON_VI_TRI          CHAR(10)      NULL,
    SO_LUONG_VAT_LY        INT           NULL,
    SO_LUONG_KHA_DUNG      INT           NULL,
    HAN_SU_DUNG            DATE          NULL,
    TRANG_THAI_TON         NVARCHAR(50)  NULL,
    NGUYEN_NHAN_DU_KIEN    NVARCHAR(255) NULL,
    GHI_CHU                NVARCHAR(255) NULL,
    CONSTRAINT PK_ChiTietCanhBaoTonKho PRIMARY KEY (MA_CHI_TIET_CANH_BAO)
);
GO

-- 16.4 NhiemVuXacMinhCanhBao
CREATE TABLE NhiemVuXacMinhCanhBao (
    MA_NHIEM_VU             CHAR(10)      NOT NULL,
    MA_CANH_BAO             CHAR(10)      NOT NULL,
    NGUOI_DUOC_PHAN_CONG    CHAR(10)      NOT NULL,
    NOI_DUNG_YEU_CAU        NVARCHAR(255) NOT NULL,
    THOI_HAN                DATETIME2(0)  NULL,
    TRANG_THAI_NHIEM_VU     NVARCHAR(50)  NOT NULL,
    KET_QUA_TOM_TAT         NVARCHAR(255) NULL,
    CONSTRAINT PK_NhiemVuXacMinhCanhBao PRIMARY KEY (MA_NHIEM_VU)
);
GO

-- 16.5 KetQuaXacMinhCanhBao
CREATE TABLE KetQuaXacMinhCanhBao (
    MA_KET_QUA            CHAR(10)      NOT NULL,
    MA_NHIEM_VU           CHAR(10)      NOT NULL,
    MA_CANH_BAO           CHAR(10)      NOT NULL,
    SO_LUONG_THUC_TE      INT           NULL,
    MA_VI_TRI_THUC_TE     CHAR(10)      NULL,
    MA_LO_HANG_THUC_TE    CHAR(10)      NULL,
    TINH_TRANG_HANG       NVARCHAR(100) NULL,
    GHI_CHU               NVARCHAR(255) NULL,
    THOI_DIEM_CAP_NHAT    DATETIME2(0)  NOT NULL,
    NGUOI_CAP_NHAT        CHAR(10)      NOT NULL,
    CONSTRAINT PK_KetQuaXacMinhCanhBao PRIMARY KEY (MA_KET_QUA)
);
GO

-- 16.6 PhuongAnXuLyCanhBao
CREATE TABLE PhuongAnXuLyCanhBao (
    MA_PHUONG_AN           CHAR(10)      NOT NULL,
    MA_CANH_BAO            CHAR(10)      NOT NULL,
    LOAI_PHUONG_AN         NVARCHAR(100) NOT NULL,
    NOI_DUNG_PHUONG_AN     NVARCHAR(255) NULL,
    NGUOI_CHON             CHAR(10)      NOT NULL,
    THOI_DIEM_CHON         DATETIME2(0)  NOT NULL,
    TRANG_THAI_PHUONG_AN   NVARCHAR(50)  NOT NULL,
    GHI_CHU                NVARCHAR(255) NULL,
    CONSTRAINT PK_PhuongAnXuLyCanhBao PRIMARY KEY (MA_PHUONG_AN)
);
GO

-- 16.7 YeuCauMuaBoSung
CREATE TABLE YeuCauMuaBoSung (
    MA_YEU_CAU_MUA       CHAR(10)      NOT NULL,
    MA_CANH_BAO          CHAR(10)      NOT NULL,
    MA_MAT_HANG          CHAR(10)      NOT NULL,
    MA_KHO               CHAR(10)      NOT NULL,
    SO_LUONG_DE_XUAT     INT           NOT NULL,
    LY_DO                NVARCHAR(255) NULL,
    TRANG_THAI_YEU_CAU   NVARCHAR(50)  NOT NULL,
    NGUOI_TAO            CHAR(10)      NOT NULL,
    THOI_DIEM_TAO        DATETIME2(0)  NOT NULL,
    CONSTRAINT PK_YeuCauMuaBoSung PRIMARY KEY (MA_YEU_CAU_MUA)
);
GO

-- =====================================================================
-- 9. TÀI KHOẢN ĐĂNG NHẬP (1 bảng)
-- =====================================================================
...
CREATE TABLE TaiKhoan (
    ...
    TRANG_THAI_TAI_KHOAN    NVARCHAR(30)  NOT NULL,
    ...
    CONSTRAINT UQ_TaiKhoan_NhanVien UNIQUE (MA_NHAN_VIEN),
    CONSTRAINT UQ_TaiKhoan_TenDangNhap UNIQUE (TEN_DANG_NHAP)
);
GO

/* =====================================================================
   10. KHAI BÁO TOÀN BỘ FOREIGN KEY
...
-- CanhBaoTonKho
ALTER TABLE CanhBaoTonKho ADD CONSTRAINT FK_CanhBaoTonKho_Kho FOREIGN KEY (MA_KHO) REFERENCES Kho(MA_KHO);
ALTER TABLE CanhBaoTonKho ADD CONSTRAINT FK_CanhBaoTonKho_MatHang FOREIGN KEY (MA_MAT_HANG) REFERENCES MatHang(MA_MAT_HANG);
ALTER TABLE CanhBaoTonKho ADD CONSTRAINT FK_CanhBaoTonKho_LoHang FOREIGN KEY (MA_LO_HANG) REFERENCES LoHang(MA_LO_HANG);
ALTER TABLE CanhBaoTonKho ADD CONSTRAINT FK_CanhBaoTonKho_ViTriKho FOREIGN KEY (MA_VI_TRI) REFERENCES ViTriKho(MA_VI_TRI);

-- CauHinhDinhMucTon
ALTER TABLE CauHinhDinhMucTon ADD CONSTRAINT FK_CauHinhDinhMucTon_Kho FOREIGN KEY (MA_KHO) REFERENCES Kho(MA_KHO);
ALTER TABLE CauHinhDinhMucTon ADD CONSTRAINT FK_CauHinhDinhMucTon_MatHang FOREIGN KEY (MA_MAT_HANG) REFERENCES MatHang(MA_MAT_HANG);

-- ChiTietCanhBaoTonKho
ALTER TABLE ChiTietCanhBaoTonKho ADD CONSTRAINT FK_CTCanhBao_CanhBao FOREIGN KEY (MA_CANH_BAO) REFERENCES CanhBaoTonKho(MA_CANH_BAO);
ALTER TABLE ChiTietCanhBaoTonKho ADD CONSTRAINT FK_CTCanhBao_TonViTri FOREIGN KEY (MA_TON_VI_TRI) REFERENCES TonTheoViTri(MA_TON_VI_TRI);

-- NhiemVuXacMinhCanhBao
ALTER TABLE NhiemVuXacMinhCanhBao ADD CONSTRAINT FK_NVXacMinh_CanhBao FOREIGN KEY (MA_CANH_BAO) REFERENCES CanhBaoTonKho(MA_CANH_BAO);
ALTER TABLE NhiemVuXacMinhCanhBao ADD CONSTRAINT FK_NVXacMinh_NguoiDuocPhanCong FOREIGN KEY (NGUOI_DUOC_PHAN_CONG) REFERENCES NhanVien(MA_NHAN_VIEN);

-- KetQuaXacMinhCanhBao
ALTER TABLE KetQuaXacMinhCanhBao ADD CONSTRAINT FK_KQXacMinh_NhiemVu FOREIGN KEY (MA_NHIEM_VU) REFERENCES NhiemVuXacMinhCanhBao(MA_NHIEM_VU);
ALTER TABLE KetQuaXacMinhCanhBao ADD CONSTRAINT FK_KQXacMinh_CanhBao FOREIGN KEY (MA_CANH_BAO) REFERENCES CanhBaoTonKho(MA_CANH_BAO);
ALTER TABLE KetQuaXacMinhCanhBao ADD CONSTRAINT FK_KQXacMinh_ViTriThucTe FOREIGN KEY (MA_VI_TRI_THUC_TE) REFERENCES ViTriKho(MA_VI_TRI);
ALTER TABLE KetQuaXacMinhCanhBao ADD CONSTRAINT FK_KQXacMinh_LoHangThucTe FOREIGN KEY (MA_LO_HANG_THUC_TE) REFERENCES LoHang(MA_LO_HANG);
ALTER TABLE KetQuaXacMinhCanhBao ADD CONSTRAINT FK_KQXacMinh_NguoiCapNhat FOREIGN KEY (NGUOI_CAP_NHAT) REFERENCES NhanVien(MA_NHAN_VIEN);

-- PhuongAnXuLyCanhBao
ALTER TABLE PhuongAnXuLyCanhBao ADD CONSTRAINT FK_PhuongAnCanhBao_CanhBao FOREIGN KEY (MA_CANH_BAO) REFERENCES CanhBaoTonKho(MA_CANH_BAO);
ALTER TABLE PhuongAnXuLyCanhBao ADD CONSTRAINT FK_PhuongAnCanhBao_NguoiChon FOREIGN KEY (NGUOI_CHON) REFERENCES NhanVien(MA_NHAN_VIEN);

-- YeuCauMuaBoSung
ALTER TABLE YeuCauMuaBoSung ADD CONSTRAINT FK_YeuCauMua_CanhBao FOREIGN KEY (MA_CANH_BAO) REFERENCES CanhBaoTonKho(MA_CANH_BAO);
ALTER TABLE YeuCauMuaBoSung ADD CONSTRAINT FK_YeuCauMua_MatHang FOREIGN KEY (MA_MAT_HANG) REFERENCES MatHang(MA_MAT_HANG);
ALTER TABLE YeuCauMuaBoSung ADD CONSTRAINT FK_YeuCauMua_Kho FOREIGN KEY (MA_KHO) REFERENCES Kho(MA_KHO);
ALTER TABLE YeuCauMuaBoSung ADD CONSTRAINT FK_YeuCauMua_NguoiTao FOREIGN KEY (NGUOI_TAO) REFERENCES NhanVien(MA_NHAN_VIEN);

-- TaiKhoan
ALTER TABLE TaiKhoan ADD CONSTRAINT FK_TaiKhoan_NhanVien FOREIGN KEY (MA_NHAN_VIEN) REFERENCES NhanVien(MA_NHAN_VIEN);

GO


/* =====================================================================
   MIGRATION: THÊM BẢNG "TÀI KHOẢN ĐĂNG NHẬP" (TaiKhoan) VÀO DB ĐÃ CÓ SẴN
   - Mỗi nhân viên (NhanVien) có tối đa 1 tài khoản đăng nhập (UNIQUE).
   - Mật khẩu PHẢI lưu dạng đã băm (hash), không lưu plaintext.
   Script có IF NOT EXISTS nên chạy lại nhiều lần vẫn an toàn.
   ===================================================================== */


-- ---------------------------------------------------------------------
-- 1. TẠO BẢNG TaiKhoan (nếu chưa có)
-- ---------------------------------------------------------------------
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'TaiKhoan')
BEGIN
    CREATE TABLE TaiKhoan (
        MA_TAI_KHOAN            CHAR(10)      NOT NULL,
        MA_NHAN_VIEN             CHAR(10)      NOT NULL,
...
-- ---------------------------------------------------------------------
-- 2. THÊM FOREIGN KEY tới NhanVien (nếu chưa có)
-- ---------------------------------------------------------------------
...
PRINT N'Hoàn tất: đã thêm bảng TaiKhoan (nếu chưa có) + FK tới NhanVien.';
GO

/* =====================================================================
   GHI CHÚ:
   - MAT_KHAU_HASH lưu chuỗi đã băm (vd bcrypt: $2b$10$...), KHÔNG lưu
     mật khẩu gốc. Việc băm thực hiện ở tầng ứng dụng (Node.js) trước
     khi INSERT/UPDATE xuống DB.
   - UNIQUE (MA_NHAN_VIEN) đảm bảo 1 nhân viên chỉ có 1 tài khoản.
     Nếu sau này cần nhiều tài khoản/nhân viên (vd tài khoản phụ), bỏ
     UNIQUE này đi.
   - TRANG_THAI_TAI_KHOAN gợi ý dùng các giá trị: N'Hoạt động',
     N'Khóa', N'Chưa kích hoạt'.
   ===================================================================== */
...
/* =====================================================================
   ...
   - Mục "16. Cảnh báo tồn kho" có 8 bảng trong đặc tả gốc, nhưng bảng
     16.8 NhatKyThaoTac trùng hoàn toàn với bảng NhatKyThaoTac ở Mục 7
     (dùng chung) nên KHÔNG tạo lại - tổng số bảng thực tế trong CSDL là
     49 (gốc) + 7 (cảnh báo tồn kho) + 1 (TaiKhoan) = 57 bảng.
   - TaiKhoan.MAT_KHAU_HASH lưu mật khẩu ĐÃ BĂM (hash, vd bcrypt), không
     bao giờ lưu mật khẩu dạng plaintext. Việc băm thực hiện ở tầng
     ứng dụng (Node.js) trước khi ghi xuống DB.
