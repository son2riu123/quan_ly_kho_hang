  ...
  createPhieu: async (data) => {
    ...
    try {
      ...
      await requestHeader
        ...
        .input("maDot", sql.Char(10), data.MA_DOT_KIEM_KE)
        .input("maNhom", sql.Char(10), data.MA_NHOM_KIEM_KE)
      ...
      if (data.details && data.details.length > 0) {
        for (let i = 0; i < data.details.length; i++) {
          ...
          await requestDetail
            ...
            .input("viTriHeThong", sql.Char(10), detail.MA_VI_TRI_HE_THONG)
            .input("viTriThucTe", sql.Char(10), detail.MA_VI_TRI_THUC_TE || detail.MA_VI_TRI_HE_THONG)
