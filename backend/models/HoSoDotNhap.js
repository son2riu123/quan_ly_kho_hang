...
const HoSoDotNhap = {
  ...
  create: async (data) => {
    ...
    await pool.request()
      ...
      .input("maBienBanGiaoNhan", sql.Char(10), data.MA_BIEN_BAN_GIAO_NHAN ? data.MA_BIEN_BAN_GIAO_NHAN.trim() : null)
      .input("maBienBanKiemNghiem", sql.Char(10), data.MA_BIEN_BAN_KIEM_NGHIEM ? data.MA_BIEN_BAN_KIEM_NGHIEM.trim() : null)
